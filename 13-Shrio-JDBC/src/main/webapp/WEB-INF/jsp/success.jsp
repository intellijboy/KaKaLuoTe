...
<h1>
    <shrio:hasRole name="SHRIO_ADMIN">SHRIO_ADMIN角色显示</shrio:hasRole>
    <shrio:hasRole name="SHRIO_USER">SHRIO_USER角色显示</shrio:hasRole>
    <shrio:hasRole name="SHARIO_QUERY">SHRIO_QUERY角色显示</shrio:hasRole>
</h1>
