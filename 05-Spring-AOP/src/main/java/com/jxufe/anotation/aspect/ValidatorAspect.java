...
public class ValidatorAspect {
    ...
    public void beforedMethod(JoinPoint joinPoint) throws MyArithmeticException {
        ...
        System.out.println("[Anotation验证前置通知]:"+"method is "+methodName+" args is"+ Arrays.asList(args));
    }
    ...
    public void afterMethod(JoinPoint joinPoint){
        String methodName = joinPoint.getSignature().getName();
        Object args[] = joinPoint.getArgs();
        System.out.println("[Anotation验证后置通知]:"+"method is "+methodName+" args is"+ Arrays.asList(args));
    }
    ...
    public void afterReturnMethod( Object result){
        System.out.println("[Anotation验证返回通知]：reuslt="+result);
    }
    ...
    public void afterThrowMethod(Exception ex){
        System.out.println("[Anotation验证返回通知]：reuslt="+ex.getMessage());
        ex.printStackTrace();
    }
}
