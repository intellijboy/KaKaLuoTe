...
(function ($) {
    ...
    var homePageTitle = "主页", homePageHref = null, navMenuList = "#navMenu_list",
        ...
        btnFullScreen = "#btnFullScreen", btnExit = "#btnExit";
    ...
    window.mainpage.loadMenu = function (id) {
        ...
        if ($.array.contains(["9","10", "11","13"], id)) {
        	var json;
        	switch (id) {
			case "9":
				json="common/nav-ysapi-menu-data.json";
				break;
			case "10":
				json="common/nav-kzapi-menu-data.json";
				break;
			case "11":
				json="common/nav-demo-menu-data.json";
				break;
			case "13":
				json="common/nav-doc-menu-data.json";
				break;
			}
        	$.get(json, function (menus) {
    ...
    window.mainpage.mainTabs.loadHash = function (hash) {
        ...
        $.get("common/nav-demo-menu-data.json", function (menus) {
